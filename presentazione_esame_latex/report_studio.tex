...
\[
R=kG\footnote{$R$ è il punto ellittico ottenuto moltiplicando il generatore $G$ per il nonce crittografico $k$. È un punto "temporaneo" della firma: da $R=(x_R,y_R)$ si estrae $r=x_R \bmod n$.},\quad r=x_R\footnote{$x_R$ è la coordinata $x$ del punto ellittico $R=kG$. In ECDSA si usa $r = x_R \bmod n$.} \bmod n,\quad s=k^{-1}(z+rd)\bmod n.
\]
